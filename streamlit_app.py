...
<style>
    ...
    /* HAREKETLİ NEON BAŞLIK EFEKTİ (HERO SECTION) */
...
def run_all_algorithms(followers, posts, budget=0.0, username=""):
    ...
    for p in posts:
        ...
        all_captions += " " + cap
        if any(kw in cap for kw in ["#reklam", "#işbirliği", "işbirliği"]): collab_count += 1
...
# ---------------------------------------------------------
# 5. UYGULAMA (GİRİŞ YOK, DİREKT ANA PANEL)
# ---------------------------------------------------------

# Şov Yapan, Hareketli Ana Başlık (Hero Section)
st.markdown("""
